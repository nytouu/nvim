...
vim.cmd("autocmd VimEnter * hi FloatBorder              guifg=#181825 guibg=#181825")
vim.cmd("autocmd VimEnter * hi NotifyBackground         guifg=#181825 guibg=#181825")
...
vim.cmd("autocmd VimEnter * hi DashboardIcon            guifg=#89B4FA guibg=none")
vim.cmd("autocmd VimEnter * hi DashboardKey             guifg=#F38BA8 guibg=none")
vim.cmd("autocmd VimEnter * hi DashboardDesc            guifg=#414868 guibg=none")
vim.cmd("autocmd VimEnter * hi DashboardHeader          guifg=#414868 guibg=none")
vim.cmd("autocmd VimEnter * hi DashboardFooter          guifg=#CDD6F4 guibg=none")
...
vim.cmd('autocmd VimEnter * hi TelescopePromptNormal    guifg=#CDD6F4 guibg=#14141f')
vim.cmd('autocmd VimEnter * hi TelescopePromptTitle     guifg=#14141f guibg=#F38BA8')
vim.cmd('autocmd VimEnter * hi TelescopePromptBorder    guifg=#14141f guibg=#14141f')
vim.cmd('autocmd VimEnter * hi TelescopePromptPrefix    guifg=#F38BA8 guibg=#14141f')
