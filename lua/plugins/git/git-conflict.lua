return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>cc", "<Plug>(git-conflict-ours)", { desc = "Keep current changes" })
		vim.keymap.set("n", "<leader>ci", "<Plug>(git-conflict-theirs)", { desc = "Keep incoming changes" })
